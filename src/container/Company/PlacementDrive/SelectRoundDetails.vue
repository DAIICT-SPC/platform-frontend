...
<div class="placement-drive">
  ...
  <div class="placement-body">
    <div class="field">
      ...
      <p class="control">
        <input disabled type="number" name="processNo" placeholder="Process No" class="input" v-model="placementDrive.ProcessNo = round_no_this">
      </p>
    </div>
    ...
    <div class="field">
      ...
      <p class="control">
        <input v-validate="'required'" type="text" name="processName" placeholder="Process Name" class="input" v-model="placementDrive.ProcessName">
      </p>
    ...
    <div class="field">
      ...
      <p class="control">
        <textarea v-validate="'required'" name="processDescription" class="textarea" placeholder="Enter Process Discription" v-model="placementDrive.ProcessDescription"></textarea>
      </p>
    ...
    <div class="date-time">
      <div class="field">
        ...
        <p class="control is-fullwidth">
          <datepicker placeholder="Date" :config="{ dateFormat: 'Y-m-d', static: true }" v-model="placementDrive.date"></datepicker>
        </p>
      </div>
