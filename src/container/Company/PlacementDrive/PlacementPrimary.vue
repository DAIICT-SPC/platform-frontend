...
<div class="placement-primary">
  ...
  <div class="placement-body">
    ...
    <div class="field">
      ...
      <p class="control">
        <PlacementSeasonDropdown></PlacementSeasonDropdown>
      </p>
    </div>
    ...
    <div class="date-time">
      <div class="field">
        ...
        <p class="control is-fullwidth">
          <datepicker placeholder="Date" :config="{ dateFormat: 'Y-m-d H:i', enableTime: true }" v-model="placementDrive.lastDateofRegistration" name="date"></datepicker>
        </p>
    ...
    <div class="start-end-date">
      <div class="field">
        ...
        <p class="control is-fullwidth">
          <datepicker v-validate="'required'" placeholder="Date" :config="{ dateFormat: 'Y-m-d', static: true, minDate:placementDrive.lastDateofRegistration }" v-model="placementDrive.start_date" name="start_date"></datepicker>
        </p>
      ...
      <div class="field end">
        ...
        <p class="control is-fullwidth">
          <datepicker v-validate="'required'" placeholder="Date" :config="{ dateFormat: 'Y-m-d', static: true, minDate:placementDrive.start_date }" v-model="placementDrive.end_date" name="end_date"></datepicker>
        </p>
