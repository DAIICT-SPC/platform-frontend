...
<div class="placement-season-tiles">
  ...
  <div class="columns is-multiline" v-if="showData">
    <div class="column is-half" v-for="drive in drives">
      <div class="card placement-tiles">
        ...
        <div class="card-content">
          <div class="content">
            Job Title:&nbsp;<b>{{ drive.job_title }}</b><br> Location:&nbsp;
            <b>{{ drive.location }}</b>
          </div>
        </div>
  ...
  <div class="box">
    <div class="bottom" v-if="!showData">
      <h3 class="title">No Posts to follow. Kindly move back and select Placement Season Again</h3>
    </div>
  </div>
