  ...
  <div class="placement-season-manage-head" v-if="showData">
    ...
    <div class="field has-addons">
      <p class="control is-fullwidth">
        <input v-model="title" v-validate="'required'" :class="{'input': true, 'is-danger': errors.has('season') }" @keyup.enter="createSeason" type="text" name="season" placeholder="Create New Placement Season">
      </p>
      <p class="control">
