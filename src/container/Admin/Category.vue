    ...
    <div class="category box">
      ...
      <div class="cat-body">
        <ul class="category-items">
          <li v-for="category,index in categories">{{index+1}}) {{ category.name }}</li>
        </ul>
      </div>
      ...
      <div class="add-category">
        <div >
          <div class="field has-addons">
            <p class="control">
              <input v-validate="'required'" v-model="title" :class="{'input': true, 'is-danger': errors.has('cat') }" name="cat" type="text" placeholder="Find a repository">
            </p>
            <p class="control">
