			...
			<div class="modal-card">
				...
				<section class="modal-card-body">
					...
					<div class="application-list">
						...
						<div class="admin-selection-body" v-for="st in students">
							<div class="">
...
export default{
	...
	methods: {
		getApplicationList() {
			admin.getApplicationList(this.getUserId(), this.placement_id)
			.then((response) => {
		...
		validateAndDownloadResumes() {
			this.validate().then(() => {
				admin.postDownloadResumes(this.getUserId(), this.selected)
				.then((response) => {
