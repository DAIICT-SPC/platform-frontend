<template lang="html">
  <div class="add-eligibility-criteria-box">
    <a v-if="hidden" class="button is-white" @click="hidden=!hidden">Add</a>
    ...
    <div class="modal is-active" v-if="!hidden">
      ...
      <div class="modal-card">
        ...
        <footer class="modal-card-foot">
          ...
          <a class="button" v-on:click="hidden=true">Cancel</a>
        </footer>
      </div>
    </div>
  </div>
...
import EditEducationDropdown from '@/components/Admin/EditEducationDropdown';
export default {
